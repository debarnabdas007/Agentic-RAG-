# Skyclad Ventures: Agentic RAG Architecture

This is my submission for the Skyclad AI Engineering Intern Assignment. 
...
3. [Engineering Decisions Log](#engineering-decisions-log)
4. [Handling Failure Modes](#handling-failure-modes)
